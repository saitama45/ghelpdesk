...
<template>
    <div ref="containerRef" class="relative w-full">
        <div
            @click="openDropdown"
            class="w-full bg-white border border-gray-300 rounded-lg shadow-sm pl-3 pr-10 py-2.5 text-left cursor-text focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500 transition-all duration-200 dark:bg-gray-800 dark:border-gray-600"
            :class="[
        ...
        >
            <div v-if="!isOpen">
                <span v-if="displayLabel" class="text-gray-900 break-words line-clamp-2 dark:text-gray-100">
                    {{ displayLabel }}
                </span>

...
<template>
    <div ref="containerRef" class="relative">
        <button
            ...
            @click="toggle"
            :disabled="disabled"
            class="w-full bg-white border border-gray-300 rounded-lg shadow-sm pl-3 pr-10 py-2.5 text-left cursor-default focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 sm:text-sm transition-all duration-200 dark:bg-gray-800 dark:border-gray-600"
        ...
        >
            <span class="block truncate">
                <slot name="trigger" :selected="selectedOption" :placeholder="placeholder">
                    <span v-if="selectedOption" class="text-gray-900 dark:text-gray-100">
        ...
        <Teleport to="body">
            ...
            >
                <div 
                    ...
                    class="fixed z-[9999] bg-white shadow-2xl border border-gray-200 rounded-lg overflow-hidden flex flex-col dark:bg-gray-800 dark:border-gray-700"
                    :style="dropdownStyle"
                >
                    <div class="overflow-y-auto overscroll-contain flex-grow custom-scrollbar">
                        <ul class="py-1">
                            <li
                                ...
                                :key="index"
                                class="text-gray-900 cursor-pointer select-none relative py-2.5 pl-3 pr-9 hover:bg-blue-50 transition-colors dark:text-slate-100 dark:hover:bg-blue-500/15"
                                @click="select(option)"
                            >
                            ...
                            <li v-if="options.length === 0" class="px-3 py-4 text-sm text-gray-500 text-center italic dark:text-gray-300">

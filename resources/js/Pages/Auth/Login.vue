...
<template>
    <GuestLayout>
        <Head title="Login - The Digital Office of TGI" />
        ...
        <div v-if="info" class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl flex items-center">
            <div class="flex-shrink-0 w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
            </div>
            <span class="text-sm font-bold text-blue-800">{{ info }}</span>
        </div>
        ...
        <div class="relative my-6">
            ...
            <div class="relative flex justify-center text-xs">
                <span class="bg-white px-3 text-slate-400 font-semibold uppercase tracking-widest dark:bg-gray-800">or</span>
            </div>
        </div>
        ...
        <a
            ...
            class="flex items-center justify-center w-full gap-3 px-4 py-3.5 bg-white border-2 border-slate-200 hover:border-slate-300 hover:bg-slate-50 rounded-2xl text-sm font-bold text-slate-700 transition-all duration-200 shadow-sm dark:bg-gray-800"
        >
        ...
        <button
            ...
            type="button"
            disabled
            class="flex items-center justify-center w-full gap-3 px-4 py-3.5 bg-slate-100 border-2 border-slate-200 rounded-2xl text-sm font-bold text-slate-400 cursor-not-allowed shadow-sm"
        >

        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <template #body="{ data }">
                        <tr v-for="category in data" :key="category.id" class="hover:bg-gray-50 transition-colors dark:hover:bg-gray-700">
            ...
            <div class="flex items-center justify-center min-h-screen px-4 py-6">
                ...
                <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 border border-gray-100 transform transition-all dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Import Categories</h3>
                        ...
                        <div class="rounded-lg border border-dashed border-gray-300 bg-gray-50 p-4 dark:bg-gray-900/50 dark:border-gray-600">
                            <a href="/categories/template" class="flex items-center space-x-3 text-blue-600 hover:text-blue-800 transition-colors group">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-gray-300">categories-import-template.csv</div>
                                </div>
                            </a>
                        </div>
            ...
            <div class="flex items-center justify-center min-h-screen px-4 py-6">
                ...
                <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 border border-gray-100 transform transition-all dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <form @submit.prevent="submitForm" class="space-y-5">
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1 dark:text-gray-300">Category Name</label>

            ...
            <div class="flex items-center justify-center min-h-screen px-4 py-6">
                ...
                <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 border border-gray-100 transform transition-all">
                    ...
                    <form @submit.prevent="submitForm" class="space-y-5">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Company Code</label>
                        ...
                        <div v-if="isEditing" class="flex items-center">
                            ...
                            <label for="is_active" class="ml-2 text-sm font-medium text-gray-700">Active Company</label>
                        </div>

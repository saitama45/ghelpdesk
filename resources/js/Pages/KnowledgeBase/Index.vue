        ...
        <div class="py-6">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 mb-8 shadow-lg">
                ...
                <div class="max-w-2xl mx-auto relative">
                    ...
                    <input 
                        ...
                        type="text" 
                        class="block w-full pl-11 pr-4 py-4 rounded-xl border-none focus:ring-4 focus:ring-white/20 shadow-xl text-gray-900 placeholder-gray-400 font-medium dark:text-gray-100" 
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <aside class="w-full lg:w-64 shrink-0">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-20 dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-4 border-b border-gray-100 bg-gray-50/50 flex items-center space-x-2 dark:border-gray-700">
                            ...
                            <h4 class="text-xs font-black text-gray-400 uppercase tracking-widest dark:text-gray-400">Categories</h4>
                        </div>
                        <nav class="p-2 space-y-1">
                            ...
                            >
                                ...
                                <span class="text-[10px] bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded-full dark:bg-gray-800 dark:text-gray-300">{{ totalArticles }}</span>
                            </Link>
                            <Link 
                            ...
                            >
                                ...
                                <span class="text-[10px] bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded-full dark:bg-gray-800 dark:text-gray-300">{{ cat.articles_count }}</span>
                            </Link>
                        </nav>
                    </div>
                </aside>
                ...
                <div class="flex-1">
                    <div v-if="articles.data.length > 0">
                        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                            <Link 
                                ...
                                class="group bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300 flex flex-col h-full dark:bg-gray-800 dark:border-gray-700"
                            >
                                <div class="p-5 flex-1">
                                    <div class="flex items-center space-x-2 mb-3">
                                        ...
                                        <span class="text-[10px] text-gray-400 font-medium dark:text-gray-400">
                                            {{ formatDate(article.updated_at) }}
                                        </span>
                                    </div>
                                    <h5 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors line-clamp-2 dark:text-gray-100">{{ article.title }}</h5>
                                    <p class="text-sm text-gray-500 line-clamp-3 mb-4 leading-relaxed dark:text-gray-300" v-html="stripHtml(article.content)"></p>
                                </div>
                                <div class="p-5 pt-0 mt-auto border-t border-gray-50 flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div class="w-6 h-6 rounded-full bg-gray-100 flex items-center justify-center text-[10px] font-bold text-gray-500 mr-2 dark:bg-gray-800 dark:text-gray-300">
                                            {{ article.author?.name?.charAt(0) }}
                                        </div>
                                        <span class="text-xs text-gray-600 font-medium dark:text-gray-300">{{ article.author?.name }}</span>
                                    </div>
                                    <div class="flex items-center text-gray-400 text-xs font-medium dark:text-gray-400">
                    ...
                    <div v-else class="text-center py-20 bg-white rounded-2xl border border-dashed border-gray-300 dark:bg-gray-800 dark:border-gray-600">
                        <div class="bg-gray-50 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 dark:bg-gray-900/50">
                            <svg class="w-10 h-10 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.172 9.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </div>
                        <h4 class="text-xl font-bold text-gray-900 mb-1 dark:text-gray-100">No articles found</h4>
                        <p class="text-gray-500 dark:text-gray-300">Try adjusting your search or filter to find what you're looking for.</p>
                        <button 
                            @click="clearFilters"

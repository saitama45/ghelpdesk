...
const form = useForm({
    ...
    effectivity_date: props.posRequest?.effectivity_date ?? '',
...
<template>
    <AppLayout :title="isEditing ? 'Edit POS Request' : 'Create POS Request'">
            ...
            <div class="max-w-[1600px] mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200/50 p-10 border border-gray-100 relative overflow-hidden">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                                ...
                                <div class="space-y-2">
                                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Effectivity Date</label>
                                    <input v-model="form.effectivity_date" type="date" required 
                                           :class="[getError('effectivity_date') ? 'border-rose-500 bg-rose-50' : 'bg-gray-50 border-gray-50']"
                                           class="w-full border-2 rounded-2xl px-5 py-4 text-sm font-bold focus:bg-white focus:border-indigo-500 focus:ring-0 transition-all outline-none">
                                    <p v-if="getError('effectivity_date')" class="text-[10px] text-rose-600 font-bold ml-1">{{ getError('effectivity_date') }}</p>
                                </div>
                            </div>
                            ...
                            >
                                <div v-for="(row, index) in form.details" :key="index" 
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-5 gap-6 mb-8 p-6 bg-white/50 rounded-3xl border border-gray-100">
                                        ...
                                        <div class="space-y-2">
                                            <label class="block text-[9px] font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Mgr's Meal</label>
                                            <input v-model="row.mgr_meal" class="w-full bg-white border-2 border-gray-100 rounded-xl px-4 py-3 text-sm font-bold text-center focus:border-indigo-500 focus:ring-0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                        ...
                                        <div class="grid grid-cols-1 gap-4">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <input v-model="row.category" placeholder="Group tagging..."
                                                       class="w-full bg-white border-2 border-gray-100 rounded-xl px-5 py-3 text-sm font-bold focus:border-indigo-500 focus:ring-0 outline-none">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="flex justify-end items-center space-x-8 pb-12">
                        <Link :href="route('pos-requests.index')" class="text-xs font-black text-gray-400 uppercase tracking-[0.3em] hover:text-gray-900 transition-all underline decoration-2 decoration-transparent hover:decoration-indigo-500 underline-offset-8">Discard Request</Link>

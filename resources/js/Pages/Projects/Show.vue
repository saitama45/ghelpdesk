...
<template>
    ...
    <AppLayout>
                ...
                <div v-if="activeTab === 'overview'" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-6">
                        <div class="bg-white shadow rounded-lg p-6 border border-gray-200">
                            ...
                            <div class="space-y-4">
                                <div v-for="member in project.team_members" :key="member.id" class="flex items-center justify-between">
                                ...
                                <button @click="showManageTeamModal = true" class="w-full mt-4 py-2 border-2 border-dashed border-gray-300 rounded-md text-sm text-gray-500 hover:border-blue-400 hover:text-blue-500 transition-colors">
                                    Manage Team
                                </button>
                            </div>
                        </div>
        ...
        <!-- Manage Team Modal -->
        <Modal :show="showManageTeamModal" @close="showManageTeamModal = false">
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-3 max-h-[400px] overflow-y-auto pr-2">
                            <div v-for="member in project.team_members" :key="member.id" class="flex items-center justify-between p-3 bg-gray-50 rounded-xl border border-gray-100 group">
                            ...
                            <div v-if="!project.team_members?.length" class="text-center py-8 text-gray-400 text-sm italic">
                        ...
                        <form @submit.prevent="addTeamMember" class="space-y-4">
                            ...
                            <div class="relative">
                                ...
                                <div class="relative flex justify-center text-xs uppercase">
                                    <span class="px-2 bg-gray-50 text-gray-500 font-bold">Or External Name</span>
                                </div>
                            </div>
                            ...
                            <div class="pt-4">
                                <PrimaryButton class="w-full justify-center" :disabled="teamForm.processing">

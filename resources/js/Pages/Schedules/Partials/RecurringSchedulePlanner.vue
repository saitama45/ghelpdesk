...
function actionLabel(action) { return action === 'approval' ? 'Needs approval' : action }
function actionBadgeClass(action) { return { create: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-300', approval: 'bg-violet-100 text-violet-700 dark:bg-violet-500/15 dark:text-violet-300', protected: 'bg-amber-100 text-amber-700 dark:bg-amber-500/15 dark:text-amber-300' }[action] }

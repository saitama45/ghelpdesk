...
// Export mirrors whatever the list is currently filtered to.
const exportUrl = computed(() => {
    ...
    return query ? `/users/export?${query}` : '/users/export';
});
            ...
            >
                <template #actions>
                    ...
                    <a
                        ...
                        :href="exportUrl"
                        class="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors flex items-center space-x-2 text-sm font-medium shadow-sm whitespace-nowrap dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600"
                        title="Export the current user list to Excel"
                    >
                ...
                <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 border border-gray-100 transform transition-all dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <form @submit.prevent="createUser" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input v-model="createForm.employee_id_no" type="text" required maxlength="255" class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm dark:border-gray-600">
                        </div>
                        <div>

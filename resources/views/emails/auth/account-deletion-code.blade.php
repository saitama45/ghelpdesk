...
<body>
    <div class="wrapper">
        ...
        <div class="content">
            <p>Hello {{ $user->name }},</p>
            <p>Enter this code on the account deletion page to confirm you want your account deleted:</p>

            <div class="code">{{ $code }}</div>

            <p class="meta">This code expires in {{ $validForMinutes }} minutes.</p>
            <p class="meta">If you didn't ask to delete your account, ignore this email — nothing happens without this code.</p>
        </div>
